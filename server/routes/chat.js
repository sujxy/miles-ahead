...
import { handleChat_1, handleChat_2,AddChat, GetLatestChatId, GetColleges, GetJobs } from "../controllers/chat.js";
...
chatRouter.post("/p3/colleges",GetColleges);
chatRouter.post("/p3/jobs",GetJobs);
